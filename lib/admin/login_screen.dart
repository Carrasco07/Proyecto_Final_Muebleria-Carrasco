...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (mounted) context.go('/gestion/dashboard');
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          return Stack(
            children: [
              // 1. BOTÓN DE REGRESAR (Fijo en la parte superior izquierda)
              Positioned(
                top: 20,
                left: 20,
                child: SafeArea(
              ...
              Center(
                child: SingleChildScrollView(
                  ...
                  child: Container(
                    constraints: const BoxConstraints(maxWidth: 450), // Mantiene un ancho elegante en Web
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        const SizedBox(height: 40), // Espacio por si el botón se encima en pantallas mini
                        
                        // Icono de administración premium
                        Container(
